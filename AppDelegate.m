...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    detailNavVC.navigationBar.tintColor = [UIColor blackColor];
    
    MasterViewController *masterVC = [[MasterViewController alloc] initWithNibName:@"MasterView" bundle:nil];
    ...
    masterNavVC.navigationBar.tintColor = [UIColor blackColor];
    
    // Setting up our custom split view
    MLKSplitViewController *splitVC = [[MLKSplitViewController alloc] initWithViewControllers:[NSArray arrayWithObjects:masterNavVC,detailNavVC, nil]];
